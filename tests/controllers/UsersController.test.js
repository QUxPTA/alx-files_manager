...
describe('UsersController', () => {
  describe('postNew', () => {
    it('should create a new user and return user information', async () => {
      ...
      sinon
        .stub(DBClient.db.collection('users'), 'insertOne')
        .resolves({ insertedId: 'user_id' });
    ...
    it('should return an error if email already exists', async () => {
      ...
      // Mock DBClient methods
      sinon
        .stub(DBClient.db.collection('users'), 'findOne')
        .resolves({ email: 'existing@example.com' });
  ...
  describe('getMe', () => {
    it('should return user information if a valid token is provided', async () => {
      ...
      sinon
        .stub(DBClient.db.collection('users'), 'findOne')
        .resolves({ _id: 'user_id', email: 'test@example.com' });
